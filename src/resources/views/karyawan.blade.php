...
<div class="container">
  <div class="form-group">
    ...
    <input type="kodepegawai" class="form-control" placeholder="isi kode pegawai">
  </div>

  <div class="form-group">
    <label for="namapegawai">Nama Pegawai</label>
    <input type="text" name="namapegawai" class="form-control" placeholder="isi nama pegawai">
  </div>
